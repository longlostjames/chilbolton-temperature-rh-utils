#!/usr/bin/env python3
"""Process a single month of HMP155 data from STFC format."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Process a single month of HMP155 data from STFC format.",
        epilog="""This command processes one month of Vaisala HMP155 temperature and 
relative humidity data from STFC datalogger format to CF-compliant NetCDF 
files with automated QC flagging."""
    ...
    parser.add_argument("--raw-data-base", type=str,
                        default="/gws/pw/j07/ncas_obs_vol2/cao/raw_data/met_cao/data/long-term/stfc_datalogger",
                        help="Base directory for raw data")
    parser.add_argument("--output-base", type=str,
                        default="/gws/pw/j07/ncas_obs_vol2/cao/processing/ncas-temperature-rh-1/data/long-term/level1b",
    ...
    while current_date <= end_date:
        ...
        infile = Path(args.raw_data_base) / f"chilbolton_{date_str}.csv"
