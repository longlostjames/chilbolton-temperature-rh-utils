#!/usr/bin/env python3
"""Process a single month of HMP155 data from CR1000X format."""
...
def main():
    """Process a single month of HMP155 data."""
    parser = argparse.ArgumentParser(
        description="Process a single month of HMP155 data from CR1000X format.",
